---
name: decision-ledger-maintainer
description: Maintain deprecated Decision Ledger's commands, documentation, examples, and release material as a public reference implementation. Use for changes in this repository.
---
...
Preserve original text separately from interpretation, append-only corrections, explicit answers, schema validation, and transaction ordering. Recorded words are not authenticated human approval.
